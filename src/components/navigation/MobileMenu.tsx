        ...
        <>
          ...
          >
            ...
            <div className="sticky top-0 bg-white border-b border-neutral-200 p-6 flex items-center justify-between z-10">
              ...
              <button
                onClick={onClose}
                className="w-10 h-10 flex items-center justify-center text-neutral-600 hover:bg-neutral-100 rounded-full transition-all"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
                    ...
                    {accountLinks.map((link) => {
                      ...
                      return (
                        <button
                          key={link.path}
                          onClick={() => handleNavigate(link.path)}
                          className="w-full flex items-center gap-3 px-4 py-3 text-neutral-700 hover:bg-neutral-50 rounded-xl transition-all"
                        >
              ...
              {!isAuthenticated ? (
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full py-3 bg-white border-2 border-neutral-300 hover:border-primary-500 text-neutral-900 font-semibold rounded-xl transition-all"
                  >
                    Login
                  </button>
                  <button
                    onClick={() => handleNavigate('/signup')}
                    className="w-full py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all"
                  >
                    Sign Up
                  </button>
                </div>
                ...
                <div className="pt-4 border-t border-neutral-200">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 rounded-xl transition-all font-medium"
                  >
