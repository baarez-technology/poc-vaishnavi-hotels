...
import { PRIORITY_CONFIG, STATUS_CONFIG, WO_CATEGORIES, formatDateTime } from '../../utils/maintenance';
  ...
  const renderHeader = () => (
    <div className="flex-1 min-w-0">
      <div className="flex items-center gap-2">
        <h2 className="text-lg font-semibold text-neutral-900 tracking-tight">{workOrder.displayId || workOrder.id}</h2>
        {workOrder.isOOO && (
