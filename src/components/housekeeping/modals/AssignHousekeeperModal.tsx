        ...
        <div>
          ...
          <div className="p-4 rounded-lg bg-neutral-50 border border-neutral-100">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-terra-100 flex items-center justify-center text-terra-600 font-bold text-lg">
                {room.roomNumber}
              </div>
              <div className="flex-1">
                <p className="text-[13px] font-semibold text-neutral-900">Room {room.roomNumber}</p>
                <div className="flex items-center gap-2 mt-1">
                  <span className="px-2 py-0.5 bg-white border border-neutral-200 text-neutral-600 rounded text-[11px] font-medium">
                    {room.type}
                  </span>
                  <span className="px-2 py-0.5 bg-white border border-neutral-200 text-neutral-600 rounded text-[11px] font-medium flex items-center gap-1">
        ...
        <div>
            ...
            {housekeepers.map(housekeeper => {
              ...
              return (
                ...
                >
                  ...
                  {/* Avatar */}
                  <div className="w-10 h-10 rounded-lg bg-terra-100 flex items-center justify-center text-terra-600 font-semibold text-[13px] flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <p className="font-semibold text-neutral-900 text-[13px] truncate">{housekeeper.name}</p>
          ...
          {housekeepers.length === 0 && (
            <div className="p-8 rounded-lg bg-neutral-50 border border-neutral-100 text-center">
              ...
              <p className="text-[13px] font-semibold text-neutral-900">No housekeepers available</p>
              <p className="text-[11px] text-neutral-500 mt-1">All staff are currently assigned</p>
            </div>
          )}
        </div>
      </div>
