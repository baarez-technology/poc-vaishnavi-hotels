 ...
 * - data: guest data object
 * - onClose: callback function
 */

import * as React from 'react'
import { Mail, Phone, Star, Heart, TrendingUp, Calendar, Edit, MessageSquare, History } from 'lucide-react'
...
export default function GuestDrawer({ isOpen, data, onClose }) {
  ...
  return (
    <Drawer
      ...
      onClose={onClose}
      title="Guest Profile"
      description="Complete guest information"
      side="right"
    >
      {/* Content */}
      <div className="p-6 space-y-6">
        ...
        <div className="bg-[#FAF8F6] rounded-xl p-6">
          <h3 className="font-sans text-lg font-bold text-neutral-900 mb-4 flex items-center gap-2">
        ...
        <div className="bg-[#4E5840]/10 rounded-xl p-6 border border-[#4E5840]/30">
          <h3 className="font-sans text-lg font-bold text-green-900 mb-4 flex items-center gap-2">
        ...
        {data.notes && (
          <div className="bg-[#CDB261]/20 rounded-xl p-6 border border-[#CDB261]/30">
            <h3 className="font-sans text-lg font-bold text-sunset-900 mb-2">Important Notes</h3>
