...
import { forecastWithTrend } from '@/utils/admin/regression';
import { smoothAndProject } from '@/utils/admin/smoothing';
import { projectRevenue, calculateConfidenceInterval, calculateScenarios } from '@/utils/admin/forecastMath';
import { forecastDemand, detectAnomalies } from '@/utils/admin/demandModel';
